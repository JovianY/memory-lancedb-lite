                        ...
                        try {
                            ...
                            if (effectiveApiKey) {
                                ...
                                const prompt = [
                                    ...
                                    "2. Important personal facts, recently disclosed information (e.g. birthday, name, preferences) that haven't been stored long-term yet.",
                                    "3. Temporary rules, constraints, or specific instructions for how to behave in the NEXT session.",
                                    "4. The immediate context of the last few messages and any active/unfinished tasks (TODOs).",
                                    "",
                                    "RULES:",
                                    "- If a codeword or specific rule is found, YOU MUST INCLUDE IT EXACTLY.",
                                    "- Be concise but comprehensive: ensure all vital 'current state' info is preserved.",
                                    "- Output the summary in Traditional Chinese (繁體中文).",
